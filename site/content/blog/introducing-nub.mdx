...
One `paranoid: true` line turns every soft gate into a hard failure and adds the script sandbox — approved scripts then run sandboxed, with no network and a scoped filesystem.
