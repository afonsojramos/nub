...
<Bench
  label="warm reinstall · vitesse-lite · macOS"
  accent="pink"
  max={3725}
  rows={[
    { cmd: 'nub install', ms: 590, us: true },
    { cmd: 'bun install', ms: 813, ratio: 1.4 },
    { cmd: 'pnpm install', ms: 3000, ratio: 5.1 },
    { cmd: 'npm ci', ms: 3725, ratio: 6.3 },
  ]}
