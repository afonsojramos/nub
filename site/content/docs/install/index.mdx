...
<Bench
  label="warm reinstall · Vite (React) · macOS"
  accent="pink"
  max={7773}
  rows={[
    { cmd: 'nub install', ms: 419, us: true },
    { cmd: 'bun install', ms: 2029, ratio: 4.8 },
    { cmd: 'pnpm install', ms: 6851, ratio: 16.4 },
    { cmd: 'npm ci', ms: 7773, ratio: 18.6 },
  ]}
